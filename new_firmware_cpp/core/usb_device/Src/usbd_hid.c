...
__ALIGN_BEGIN static uint8_t HID_DIGITIZER_ReportDesc[HID_DIGITIZER_REPORT_DESC_SIZE] __ALIGN_END =
{
...
static uint8_t USBD_HID_Setup(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req)
{
  ...
  {
    len = MIN(HID_DIGITIZER_REPORT_DESC_SIZE, req->wLength);
    pbuf = HID_DIGITIZER_ReportDesc;
  }
